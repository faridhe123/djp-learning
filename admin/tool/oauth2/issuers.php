...
if ($mform && $mform->is_cancelled()) {
    ...
    // TPPortal .
    $docs = 'admin/tool/oauth2/issuers/tpportal';
    $params = ['action' => 'edittemplate', 'type' => 'tpportal', 'sesskey' => sesskey(), 'docslink' => $docs];
    $addurl = new moodle_url('/admin/tool/oauth2/issuers.php', $params);
    echo $renderer->single_button($addurl, 'TPPortal');
